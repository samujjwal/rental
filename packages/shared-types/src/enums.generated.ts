...
// Generated: 2026-05-09T18:04:40.246Z
...
export const BookingStatusValues = ['DRAFT', 'PENDING', 'PENDING_PAYMENT', 'PENDING_OWNER_APPROVAL', 'MANUAL_REVIEW', 'CONFIRMED', 'IN_PROGRESS', 'CANCELLED', 'PAYMENT_FAILED', 'DISPUTED', 'COMPLETED', 'AWAITING_RETURN_INSPECTION', 'REFUNDED', 'SETTLED'] as const;
...
export const DepositStatusValues = ['PENDING', 'AUTHORIZED', 'HELD', 'RELEASED', 'CAPTURED'] as const;
