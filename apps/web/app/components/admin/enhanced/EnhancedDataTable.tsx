        ...
        <Paper elevation={1} sx={{ width: '100%', overflow: 'hidden' }}>
                ...
                {enableAdvancedMode && (
                    <Box>
                        ...
                        <Collapse in={showAdvanced}>
                            <Box sx={{ mt: 2, p: 3, bgcolor: 'grey.50', borderRadius: 2, border: '1px solid', borderColor: 'divider' }}>
                                        ...
                                        {filterChips.length > 0 ? (
                                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                                                {filterChips.map(chip => (
                                                    <Box key={chip.id} sx={{ bgcolor: 'white', p: 1.5, borderRadius: 1, border: '1px solid', borderColor: 'divider' }}>
                                    ...
                                    <Box>
                                        ...
                                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                                            <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 0.5 }}>
                                                ...
                                                <Typography variant="body2" fontWeight={600}>{totalCount || data.length}</Typography>
                                            </Box>
                                            <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 0.5 }}>
                                                <Typography variant="body2">Displayed:</Typography>
                                                <Typography variant="body2" fontWeight={600}>{data.length}</Typography>
                                            </Box>
                                            <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 0.5 }}>
                                                <Typography variant="body2">Selected:</Typography>
                                                <Typography variant="body2" fontWeight={600}>{selectedCount}</Typography>
                                            </Box>
                                            <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 0.5 }}>
                                                <Typography variant="body2">Page Size:</Typography>
                                                <Typography variant="body2" fontWeight={600}>{pageSize}</Typography>
                                            </Box>
                                        </Box>
                                    </Box>
                                </Box>
            ...
            <Box sx={{ px: { xs: 1, sm: 2 }, pb: { xs: 1, sm: 2 } }}>
                ...
                {viewMode === 'table' && (
                    <TableContainer sx={{ maxHeight: 600 }}>
                        <Table size="medium" sx={{ '& .MuiTableCell-root': { py: 1.5, px: 2 } }}>
                            <TableHead>
                                {table.getHeaderGroups().map(headerGroup => (
                                    <TableRow key={headerGroup.id}>
                                        ...
                                        {(onRowView || onRowEdit || onRowDelete) && (
                                            <TableCell align="right" sx={{ width: 120, borderBottom: '2px solid', borderColor: 'divider' }}>
                                                Actions
                                            </TableCell>
                                        )}
                                    </TableRow>
            ...
            <Box sx={{
                ...
                <TablePagination
                    ...
                    page={pageIndex}
                    onPageChange={(_, page) => onPaginationChange?.({ pageIndex: page, pageSize })}
                    rowsPerPage={pageSize}
                    onRowsPerPageChange={(e) => onPaginationChange?.({ pageIndex: 0, pageSize: parseInt(e.target.value, 10) })}
