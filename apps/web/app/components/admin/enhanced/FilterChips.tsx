    ...
    return (
        <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            {filters.map((filter) => (
                <Chip
                    key={filter.id}
                    icon={(filter.icon || getFilterIcon(filter.type)) as React.ReactElement}
                    label={
            ...
            >
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                        ...
                        {selectedField && (
                            <>
                                ...
                                {(() => {
                                    const field = availableFields.find((f) => f.field === selectedField);
                ...
                <DialogActions sx={{ px: 3, py: 2, borderTop: '1px solid', borderColor: 'divider' }}>
                    ...
                    <Button
                        ...
                        variant="contained"
                        disabled={!selectedField || !filterValue || (filterOperator === 'between' && (!Array.isArray(filterValue) || filterValue.length !== 2 || !filterValue[0] || !filterValue[1]))}
                        size="medium"
                    >
                        Add Filter
                    </Button>
