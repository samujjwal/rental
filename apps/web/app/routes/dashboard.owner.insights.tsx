...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Actionable insights to grow your rental business",
    },
  ];
};
...
function InsightCard({ insight }: { insight: InsightData["insights"][0] }) {
  ...
  const config =
    configMap[insight.type as keyof typeof configMap] || configMap.opportunity;
...
export default function OwnerInsightsPage() {
  ...
  return (
    <PortalPageLayout
      ...
      description="Actionable insights to grow your rental business"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {t("dashboard.insights.healthScoreDesc")}
                  </p>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-right">
                    <p className={cn("text-sm font-medium", scoreColor)}>
                      {data.score >= 80
                        ? t("dashboard.insights.excellent")
                        : data.score >= 60
                          ? t("dashboard.insights.good")
                          : t("dashboard.insights.needsWork")}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {tabs.map((tab) => (
              ...
              >
                ...
                {tab.id === "insights"
                  ...
                  : tab.id === "trends"
                    ? t("dashboard.insights.marketTrends")
                    : t("dashboard.insights.optimization")}
              </button>
            ))}
          </div>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    {t("dashboard.insights.seasonalDemand")}
                  </CardTitle>
                  <CardDescription>
                    {t("dashboard.insights.seasonalDemandDesc")}
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    {t("dashboard.insights.pricingAnalysis")}
                  </CardTitle>
                  <CardDescription>
                    {t("dashboard.insights.pricingAnalysisDesc")}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                      <div>
                        <p className="text-sm text-muted-foreground">
                          {t("dashboard.insights.marketAverage")}
                        </p>
                        <p className="text-2xl font-bold text-foreground">
                          {formatCurrency(data.competitorAnalysis.averagePrice)}
                          /day
                        </p>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-muted-foreground">
                          {t("dashboard.insights.yourAverage")}
                        </p>
                        <p className="text-2xl font-bold text-primary">
                          {formatCurrency(data.competitorAnalysis.yourPrice)}
                          /day
                        </p>
                      </div>
                    </div>
              ...
              <Card className="lg:col-span-2">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    {t("dashboard.insights.customerSegments")}
                  </CardTitle>
                  <CardDescription>
                    {t("dashboard.insights.customerSegmentsDesc")}
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              {data.optimizations.map((opt) => (
                <Card key={opt.area}>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {t("dashboard.insights.currentTarget", {
                        current: opt.current,
                        target: opt.target,
                      })}
                    </CardDescription>
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-2">
                      <p className="text-sm font-medium text-foreground">
                        {t("dashboard.insights.suggestions")}
                      </p>
