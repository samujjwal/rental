...
export default function BookingDetail() {
    ...
    const currentStepIndex = TIMELINE_STEPS.findIndex((step) => step.status === booking.status);
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-900 capitalize">{booking.deliveryMethod}</p>
                                    {booking.deliveryAddress && (
                                        <p className="text-sm text-gray-500 mt-1">{booking.deliveryAddress}</p>
                                    )}
                                </div>
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between text-gray-600">
                                    ...
                                    <span className="font-medium">${booking.pricing?.serviceFee.toFixed(2)}</span>
                                </div>
                                {booking.pricing?.deliveryFee && (
                                    <div className="flex justify-between text-gray-600">
                                        <span>Delivery Fee</span>
                                        <span className="font-medium">${booking.pricing.deliveryFee.toFixed(2)}</span>
                                    </div>
                                )}
                                <div className="flex justify-between text-gray-600">
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6">
                                ...
                                <div className="flex items-center gap-1 mb-3">
                                    {[...Array(5)].map((_, i) => (
                                        <Star
                                            key={i}
                                            className={`w-5 h-5 ${i < booking.review!.rating
                                ...
                                <p className="text-sm text-gray-500 mt-3">
                                    Reviewed on {format(new Date(booking.review.createdAt), 'MMM d, yyyy')}
                                </p>
                            </div>
                        )}
                    </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-blue-700">
                                        Contact our support team if you have any questions or concerns about this
                                        booking.
                                    </p>
                                </div>
                            </div>
