...
import { clientLoader, clientAction, getAdminNotificationsError } from "../system/notifications";
...
describe("admin/system/notifications", () => {
  ...
  describe("error helper", () => {
    it("keeps plain thrown errors when provided", () => {
      expect(getAdminNotificationsError(new Error("fail"), "Failed to update settings")).toBe("fail");
    });
  });
});
