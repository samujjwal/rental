...
export function getAdminSecurityError(error: unknown, fallbackMessage: string): string {
  ...
  return (
    ...
    getActionableErrorMessage(error, fallbackMessage, {
      ...
      [ApiErrorType.TIMEOUT_ERROR]: "Security settings request timed out. Try again.",
    })
  );
}
...
export async function clientLoader({ request }: LoaderFunctionArgs) {
  ...
  try {
    ...
    return {
      ...
      error: getAdminSecurityError(error, "Failed to load security settings"),
    };
  }
}
...
export async function clientAction({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    return {
      success: false,
      error: getAdminSecurityError(error, "Failed to update settings"),
    };
  }
}
