      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-card shadow rounded-lg p-8">
          ...
          <div className={cn(
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h3 className={cn(
                  "text-sm font-medium",
                  requirement.required ? "text-warning-foreground" : "text-primary-foreground"
                )}>
                  {requirement.required ? 'Insurance Required' : 'Insurance Optional'}
                </h3>
                <p className={cn(
                  "mt-1 text-sm",
                  requirement.required ? "text-warning-foreground/80" : "text-primary-foreground/80"
                )}>
                  {requirement.reason}
                </p>
                {requirement.required && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Policy Number */}
            <div>
              <label htmlFor="policyNumber" className="block text-sm font-medium text-foreground">
                Policy Number *
              </label>
              <input
                type="text"
            ...
            {/* Coverage Amount */}
            <div>
              <label htmlFor="coverageAmount" className="block text-sm font-medium text-foreground">
            ...
            {/* Document Upload */}
            <div>
              <label htmlFor="documentUrl" className="block text-sm font-medium text-foreground">
