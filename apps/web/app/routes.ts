...
export default [
  // ── Public / marketing pages (own nav or MarketingLayout) ──────────────
  ...
  // ── App routes — all share the consistent top-nav from _app.tsx ─────────
  layout("routes/_app.tsx", [
    ...
    route("bookings/:id/condition-report", "routes/bookings.$id.condition-report.tsx"),
    ...
    route("insurance/claims", "routes/insurance.claims.tsx"),
    route("insurance/claims/:claimId", "routes/insurance.claims.$claimId.tsx"),
