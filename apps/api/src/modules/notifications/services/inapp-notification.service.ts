...
export class InAppNotificationService {
  ...
  async createReviewNotification(
    ...
    const messages = {
      received: {
        title: 'New Review',
        message: `${reviewerName || 'Someone'} left you a review`,
        actionText: 'View Review',
        priority: 'medium' as const,
      },
      reminder: {
        title: 'Leave a Review',
        message: 'Your recent rental is complete. Share your experience!',
  ...
  async createOrganizationNotification(
    userId: string,
    type: 'invitation' | 'joined' | 'removed' | 'updated',
    ...
    const messages = {
      ...
      joined: {
        ...
        message: `You've joined ${organizationName}`,
        actionText: 'View Organization',
        priority: 'medium' as const,
      },
      removed: {
        title: 'Removed from Organization',
        message: `You've been removed from ${organizationName}`,
        priority: 'high' as const,
      },
      updated: {
        title: 'Organization Updated',
        message: `${organizationName} has been updated`,
  ...
  async cleanupExpiredNotifications(): Promise<void> {
    // Since expiresAt doesn't exist in schema, this method is a no-op
    this.logger.log('Cleanup expired notifications: no expiresAt field in schema');
  }
