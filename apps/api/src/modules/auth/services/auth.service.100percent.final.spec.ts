...
describe('AuthService - 100% Coverage', () => {
  ...
  describe('Token Management', () => {
    test('should refresh tokens successfully', async () => {
      ...
      // Mock session lookup within transaction
      const mockSession = {
        id: 'session-1',
        refreshToken,
  ...
  describe('MFA Management', () => {
    ...
    test('should verify and enable MFA with backup codes', async () => {
      ...
      passwordService.hash.mockResolvedValue('hashed-backup-code');
      prisma.user.update.mockResolvedValue({ ...mockUser, mfaEnabled: true, mfaBackupCodes: ['hashed-backup-code'] });
