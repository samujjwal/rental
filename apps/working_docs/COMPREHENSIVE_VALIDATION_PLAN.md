...
## 11. Validation for Pending Features

### 11.1 Map View (Search)

- [ ] Map component renders correctly
- [ ] Panning/Zooming works smoothly
- [ ] "Search this area" button functionality
...
- [ ] Upload of 50+ items works within timeout
- [ ] Validation report for failed rows is clear
- [ ] Bulk status update (e.g. deactivate 10 listings) usage

### 11.3 Mobile Experience (Future)
